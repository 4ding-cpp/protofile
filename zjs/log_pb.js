...
goog.exportSymbol('proto.ding4.Different', null, global);
 ...
 * @constructor
 */
proto.ding4.Different = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ding4.Different, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ding4.Different.displayName = 'proto.ding4.Different';
}
...
proto.ding4.Log.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    targetId: jspb.Message.getFloatingPointFieldWithDefault(msg, 4, 0.0),
    different: jspb.Message.getFieldWithDefault(msg, 5, "")
  };
 ...
 * @return {!Object}
 */
proto.ding4.Different.prototype.toObject = function(opt_includeInstance) {
  return proto.ding4.Different.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ding4.Different} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ding4.Different.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ding4.Different}
 */
proto.ding4.Different.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ding4.Different;
  return proto.ding4.Different.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ding4.Different} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ding4.Different}
 */
proto.ding4.Different.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ding4.Different.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ding4.Different.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ding4.Different} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ding4.Different.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getF();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.ding4.Different.prototype.getF = function() {
...
/**
 * @param {string} value
 * @return {!proto.ding4.Different} returns this
 */
proto.ding4.Different.prototype.setF = function(value) {
 ...
 * @return {string}
 */
proto.ding4.Different.prototype.getOld = function() {
 ...
 * @return {!proto.ding4.Different} returns this
 */
proto.ding4.Different.prototype.setOld = function(value) {
 ...
 * @return {string}
 */
proto.ding4.Different.prototype.getNew = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.ding4.Different} returns this
 */
proto.ding4.Different.prototype.setNew = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};

...
export class Distribute extends jspb.Message {
  getDiscountId(): string;
  setDiscountId(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): Distribute.AsObject;
  static toObject(includeInstance: boolean, msg: Distribute): Distribute.AsObject;
  static serializeBinaryToWriter(message: Distribute, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): Distribute;
  static deserializeBinaryFromReader(message: Distribute, reader: jspb.BinaryReader): Distribute;
}

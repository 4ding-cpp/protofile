 ...
 * @const
 */
proto.ding4.Customer.repeatedFields_ = [24,25];
...
proto.ding4.Customer.prototype.getAddress = function() {
  return /** @type{?proto.ding4.Address} */ (
    jspb.Message.getWrapperField(this, address_pb.Address, 13));
};
...
/**
 * optional string register_by = 19;
 * @return {string}
 */

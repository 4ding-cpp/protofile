...
goog.exportSymbol('proto.ding4.Business.Address', null, global);
/**
 ...
 * @constructor
 */
proto.ding4.Business.Address = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ding4.Business.Address, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ding4.Business.Address.displayName = 'proto.ding4.Business.Address';
}
...
proto.ding4.Business.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    address: (f = msg.getAddress()) && proto.ding4.Business.Address.toObject(includeInstance, f),
...
proto.ding4.Business.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 16:
      ...
      break;
    case 17:
      var value = new proto.ding4.Business.Address;
      reader.readMessage(value,proto.ding4.Business.Address.deserializeBinaryFromReader);
...
proto.ding4.Business.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      17,
      f,
      proto.ding4.Business.Address.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Object}
 */
proto.ding4.Business.Address.prototype.toObject = function(opt_includeInstance) {
  return proto.ding4.Business.Address.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ding4.Business.Address} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ding4.Business.Address.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ding4.Business.Address}
 */
proto.ding4.Business.Address.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ding4.Business.Address;
  return proto.ding4.Business.Address.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ding4.Business.Address} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ding4.Business.Address}
 */
proto.ding4.Business.Address.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ding4.Business.Address.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ding4.Business.Address.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ding4.Business.Address} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ding4.Business.Address.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.ding4.Business.Address.prototype.getZipcode = function() {
...
/**
 * @param {string} value
 * @return {!proto.ding4.Business.Address} returns this
 */
proto.ding4.Business.Address.prototype.setZipcode = function(value) {
 ...
 * @return {string}
 */
proto.ding4.Business.Address.prototype.getCountry = function() {
 ...
 * @return {!proto.ding4.Business.Address} returns this
 */
proto.ding4.Business.Address.prototype.setCountry = function(value) {
 ...
 * @return {string}
 */
proto.ding4.Business.Address.prototype.getCity = function() {
 ...
 * @return {!proto.ding4.Business.Address} returns this
 */
proto.ding4.Business.Address.prototype.setCity = function(value) {
 ...
 * @return {string}
 */
proto.ding4.Business.Address.prototype.getTownship = function() {
 ...
 * @return {!proto.ding4.Business.Address} returns this
 */
proto.ding4.Business.Address.prototype.setTownship = function(value) {
 ...
 * @return {string}
 */
proto.ding4.Business.Address.prototype.getDetail = function() {
 ...
 * @return {!proto.ding4.Business.Address} returns this
 */
proto.ding4.Business.Address.prototype.setDetail = function(value) {
...
proto.ding4.Business.prototype.getAddress = function() {
  return /** @type{?proto.ding4.Business.Address} */ (
    jspb.Message.getWrapperField(this, proto.ding4.Business.Address, 17));
};


/**
 * @param {?proto.ding4.Business.Address|undefined} value
 * @return {!proto.ding4.Business} returns this
*/

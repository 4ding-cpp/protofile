...
export class ProductShell extends jspb.Message {
  ...
  setDescriptionList(value: Array<template_pb.Template>): ProductShell;
  clearDescriptionList(): ProductShell;
  ...
  setTemplateGroupList(value: Array<template_pb.Template>): ProductShell;
  clearTemplateGroupList(): ProductShell;

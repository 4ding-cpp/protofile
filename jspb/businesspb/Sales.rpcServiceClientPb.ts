...
export class SalesRPCClient {
  ...
  confirmOTPToken(
    ...
    return this.client_.rpcCall(
      this.hostname_ +
        '/ding4.SalesRPC/ConfirmOTPToken',
      request,
      metadata || {},
  ...
  findAnnouncement(
    ...
    return this.client_.rpcCall(
      this.hostname_ +
        '/ding4.SalesRPC/FindAnnouncement',
      request,
      metadata || {},
  ...
  findAnnouncementTemplate(
    ...
    return this.client_.rpcCall(
      this.hostname_ +
        '/ding4.SalesRPC/FindAnnouncementTemplate',
      request,
      metadata || {},
  ...
  findProductShell(
    ...
    return this.client_.rpcCall(
      this.hostname_ +
        '/ding4.SalesRPC/FindProductShell',
      request,
      metadata || {},

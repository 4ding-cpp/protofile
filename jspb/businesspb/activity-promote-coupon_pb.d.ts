...
export class Promote extends jspb.Message {
  getPromoteId(): string;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): Promote.AsObject;
  static toObject(includeInstance: boolean, msg: Promote): Promote.AsObject;
  static serializeBinaryToWriter(message: Promote, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): Promote;
  static deserializeBinaryFromReader(message: Promote, reader: jspb.BinaryReader): Promote;
}
